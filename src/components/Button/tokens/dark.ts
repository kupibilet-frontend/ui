...
export const button_primary_medium_color_bg_disable = "#3a3a41";
...
export const button_secondary_medium_color_bg_normal = "#3a3a41";
export const button_secondary_medium_color_bg_hover = "#3a3a41";
export const button_secondary_medium_color_bg_focus = "#3a3a41";
export const button_secondary_medium_color_bg_disable = "#f5f5f7";
export const button_secondary_medium_color_text_normal = "#ffffff";
export const button_secondary_medium_color_text_hover = "#ffffff";
export const button_secondary_medium_color_text_focus = "#ffffff";
